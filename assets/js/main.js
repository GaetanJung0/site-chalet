const translations = {
  fr: {
    'page.title': "Hameau retrouvé - Chalet à Les Carroz d'Arâches",
    'meta.description': "Louez le chalet Hameau Retrouvé aux Carroz d'Arâches. 3 chambres, 8 personnes, au cœur du Grand Massif. Réservez votre séjour à la montagne.",
    'brand.name': 'HAMEAU RETROUVÉ',
    'nav.home': 'Accueil',
    'nav.location': 'Localisation',
    'nav.activities': 'Activités',
    'nav.book': 'Réserver',
    'language.switchLabel': 'Choix de langue',
    'hero.tag': "Les Carroz d'Arâches",
    'hero.title': 'Votre chalet Hameau Retrouvé',
    'hero.subtitle': 'Un cocon chaleureux pour réunir famille et amis, à deux pas des pistes et des commerces.',
    'hero.cta': 'Voir le chalet',
    'intro.label': 'Hameau Retrouvé',
    'intro.title': 'Votre refuge alpin privé',
    'intro.paragraph1': "Le niveau supérieur concentre un séjour-cuisine de 29 m² sous charpente, équipé d'un poêle à granulés récent et ouvert sur deux balcons orientés sud.",
    'intro.paragraph2': 'Le chalet développe 80 m² habitables sur trois niveaux, avec terrasse de 10 m², jardin clos et vues dégagées sur les sommets du Grand Massif.',
    'intro.paragraph3': "L'étage intermédiaire comprend une chambre double, une chambre twin et une salle de bain avec WC. Le rez-de-jardin regroupe une deuxième chambre double avec accès extérieur, un canapé convertible, une salle de bain additionnelle et un WC indépendant.",
    ...
    'gallery.labels.dining': 'Salle à manger',
    'gallery.labels.view': 'Vue montagne',
    'gallery.labels.stove': 'Poêle à granulés',
    'gallery.labels.lounge': 'Espace détente',
    'gallery.labels.bedroom2': 'Chambre 2',
    'gallery.labels.panorama': 'Panorama',
    'practical.card1.title': 'Emplacement idéal',
    'practical.card1.text': 'Boulangerie artisanale, navette Grand Massif et location de matériel au pied du chalet • Super U à 10 min en voiture • Centre station à 1,4 km',
    ...
    'features.sleep.list': [
      '<li>Chambre double avec rangements au niveau intermédiaire</li>',
      '<li>Chambre twin (2 lits simples) idéale pour enfants ou amis</li>',
      '<li>Suite rez-de-jardin : chambre double + canapé convertible</li>',
      '<li>2 salles de bain avec baignoire + 2 WC dont 1 indépendant</li>',
      "<li>Linge fourni et lits faits à l'arrivée</li>",
      '<li>Kit bébé disponible (lit parapluie, chaise haute)</li>'
    ].join(''),
    'features.dining.title': 'Moments gourmands',
    'features.dining.desc': 'Cuisine équipée comme à la maison pour vos festins savoyards.',
    'features.dining.list': [
      '<li>Séjour de 29 m² au dernier niveau</li>',
      '<li>Poêle à granulés récent et ambiance bois chaleureuse</li>',
      '<li>Cuisine aménagée : four, plaques, micro-ondes, lave-vaisselle</li>',
      '<li>Deux balcons plein sud + terrasse et jardin de 10 m²</li>',
      '<li>Appareils à fondue/raclette et vaisselle pour 8 convives</li>'
    ].join(''),
    'features.ski.title': 'Ski & outdoor',
    'features.ski.desc': 'Tout est prêt pour vos journées sur les pistes.',
    'features.ski.list': [
      '<li>Local à ski privatif chauffé et sécurisé</li>',
      '<li>Deux places de parking extérieures dédiées</li>',
      '<li>Navette gratuite vers la télécabine juste en bas de la route</li>',
      "<li>Jardin clos pour les jeux d'hiver et les pique-niques</li>",
      '<li>Accès direct au domaine du Grand Massif (265 km de pistes)</li>'
    ].join(''),
    'features.services.title': 'Services inclus',
    'features.services.desc': 'On s’occupe des détails, vous profitez.',
    'features.services.list': [
      "<li>Lits faits, linge de maison complet et produits d'accueil</li>",
      '<li>Chauffage mixte : poêle à granulés + radiateurs électriques</li>',
      '<li>Chauffe-eau électrique et VMC simple flux pour un confort constant</li>',
      '<li>Cave/local pratique pour skis, luges ou vélos</li>',
      '<li>Maison louée avec tout le nécessaire du quotidien</li>'
    ].join(''),
    'booking.title': "Prêt à vivre l'expérience ?",
    'booking.subtitle': 'Consultez nos tarifs en direct et réservez en deux minutes.',
    'booking.primary': 'Réserver sur Airbnb',
    'booking.secondary': 'Poser une question',
    'reviews.title': 'Ce que nos voyageurs adorent',
    'reviews.item1.text': '"Chalet splendide, très propre et super bien placé. La boulangerie juste en bas est un vrai plus pour les petits-déjeuners. Nous reviendrons !"',
    'reviews.item1.author': 'Ginette',
    'reviews.item2.text': '"On se sent comme chez soi. Confort, déco chaleureuse, équipements complets. Le local à ski chauffé est top après une journée sur les pistes."',
    'reviews.item2.author': 'Joëlle',
    'reviews.item3.text': '"Parfait pour une tribu ! Cuisine très bien équipée pour les soirées raclette, poêle à granulés cosy et hôtes ultra réactifs."',
    'reviews.item3.author': 'Sylvie',
    'location.title': "Les Carroz d'Arâches",
    'location.lead': 'Station-village authentique, reliée au Grand Massif et accessible en 1h depuis Genève.',
    'location.items.bakery.title': 'Boulangerie artisanale',
    'location.items.bakery.text': '<strong>2 min à pied</strong> – pains & viennoiseries 7j/7',
    ...
    'location.items.store.title': 'Supérette Sherpa',
    'location.items.store.text': '<strong>12 min à pied</strong> – produits locaux & plats traiteur',
    ...
    'location.items.airport.text': '<strong>1h</strong> en voiture – transferts possibles',
    'location.items.plateau.title': "Plateau d'Agy",
    'location.items.plateau.text': '<strong>10 km</strong> – ski de fond & raquettes',
    'location.mapLink': 'Ouvrir dans Maps →',
    'activities.title': 'Que faire aux Carroz ?',
    'activities.subtitle': 'Une station quatre saisons qui comblera sportifs, familles et épicuriens.',
    ...
    'activities.links.events': 'Agenda & événements',
    'contact.title': 'Parlons de votre séjour',
    'contact.subtitle': 'Nous répondons sous 2h en journée pour vous aider à organiser votre venue.',
    'contact.booking.title': 'Réservation',
    'contact.booking.text': 'Vérifiez les disponibilités et réservez directement via Airbnb.',
    'contact.booking.cta': 'Réserver sur Airbnb',
    'contact.custom.title': 'Demande personnalisée',
    'contact.custom.text': "Besoin de conseils ou d'un devis sur mesure ? Envoyez-nous un message.",
    'contact.form.name': 'Nom complet',
    'contact.form.email': 'Email',
    'contact.form.message': 'Votre message',
    'contact.form.submit': 'Envoyer le message',
    'footer.brand': 'Hameau Retrouvé',
    'footer.tagline': "Chalet d'exception aux Carroz d'Arâches",
    'footer.nav': 'Navigation',
    'footer.links.home': 'Accueil',
    'footer.links.location': 'Localisation',
    'footer.links.activities': 'Activités',
    'footer.links.contact': 'Contact',
    'footer.info': 'Informations',
    'footer.address': "Les Carroz d'Arâches<br>Haute-Savoie, 74300",
    'footer.legal': 'Mentions légales',
    'footer.copyright': '&copy; 2025 Hameau Retrouvé. Tous droits réservés.'
  },
  en: {
    'page.title': "Hameau Retrouvé - Chalet in Les Carroz d'Arâches",
    'meta.description': "Rent the Hameau Retrouvé chalet in Les Carroz d'Arâches. 3 bedrooms, sleeps 8, in the heart of the Grand Massif. Book your mountain stay.",
    'brand.name': 'HAMEAU RETROUVÉ',
    'nav.home': 'Home',
    ...
    'hero.tag': "Les Carroz d'Arâches",
    'hero.title': 'Your Hameau Retrouvé chalet',
    ...
    'practical.card1.text': 'Artisan bakery, Grand Massif shuttle, and ski rental next door • Super U grocery 10 min drive • Village center 1.4 km away',
    ...
    'reviews.item1.author': 'Ginette',
    'reviews.item2.text': '"Feels just like home. Cozy décor, full equipment, and the heated ski room is perfect after a day on the slopes."',
    'reviews.item2.author': 'Joëlle',
    ...
    'location.items.bakery.text': '<strong>2 min walk</strong> – fresh bread & pastries daily',
    ...
    'location.items.store.text': '<strong>12 min walk</strong> – local produce & prepared dishes',
    ...
    'location.items.airport.text': '<strong>1 hr</strong> drive – transfer options available',
    'location.items.plateau.title': "Plateau d'Agy",
    'location.items.plateau.text': '<strong>10 km</strong> – nordic skiing & snowshoeing',
    'location.mapLink': 'Open in Maps →',
    ...
    'footer.brand': 'Hameau Retrouvé',
    'footer.tagline': "Exceptional chalet in Les Carroz d'Arâches",
    'footer.nav': 'Navigation',
    ...
    'footer.copyright': '&copy; 2025 Hameau Retrouvé. All rights reserved.'
  }
};
